...
func (c *etcdClient) InitEtcd(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/dynamos.Etcd/InitEtcd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *etcdClient) GetDatasetMetadata(ctx context.Context, in *EtcdKey, opts ...grpc.CallOption) (*Dataset, error) {
	out := new(Dataset)
	err := c.cc.Invoke(ctx, "/dynamos.Etcd/GetDatasetMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Etcd_InitEtcd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dynamos.Etcd/InitEtcd",
	}
...
func _Etcd_GetDatasetMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dynamos.Etcd/GetDatasetMetadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
